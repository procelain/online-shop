  ...
  <div>
    ...
    <div class="detail cle z-detail-box">
      <div class="detail_wrap">
        <div id="detail_img" class="detail_img">
          <div class="pic_view">
            <a id="Zoomer" class="MagicZoomPlus" style="position: relative; display: inline-block; text-decoration: none; outline: 0px; overflow: hidden; width: auto; height: auto;">
              <img :src="curShow.image" alt="" style="opacity: 1;">
              <div class="MagicZoomPup" style="z-index: 10; position: absolute; overflow: hidden;  visibility: hidden; width: 190px; height: 190px; opacity: 0.5;" />
              <div class="MagicZoomPlusHint" style="display: block; overflow: hidden; position: absolute; visibility: visible; z-index: 1; left: 2px; right: auto; top: 2px; bottom: auto; opacity: 0.75; max-width: 376px;" />
            </a>
          </div>
          <div id="item-thumbs" class="item-thumbs">
            <a class="prev" href="javascript:void(0);" @click="ImagePrev" />
            <a class="next" href="javascript:void(0);" @click="ImageNext" />
            <div class="bd">
          ...
          <dl class="loaded">
            ...
            <dd class="property">
              <ul>
                ...
                <li>
                  <span class="icon_promo">抢购</span> <span class="lbl">促销价</span><span class="unit"> <strong id="ECS_SHOPPRICE" class="nala_price red">￥{{ proDetail.shop_price }}元</strong> </span>  <span id="timedown" class="timedown" />
                </li>
                <li>
            ...
            <dd class="tobuy-box cle">
              <ul class="sku">
                <li class="skunum_li cle">
                  ...
                  <div id="skunum" class="skunum"> <span class="minus" title="减少1个数量" @click="reduceNum"><i class="iconfont">-</i></span>
                    <input id="number" v-model="buyNum" name="number" type="text" min="1" onchange="countNum(0)">
                    <span class="add" title="增加1个数量" @click="addNum"><i class="iconfont">+</i></span> <cite class="storage"> 件 </cite>
                  </div>
                  <div id="skunum" class="skunum">
                ...
                <li class="add_cart_li">
                  <a id="buy_btn" class="btn" @click="addShoppingCart">
                    <i class="iconfont">&#xe600;</i>
                    加入购物车</a>
        ...
        <div class="z-detail-left">
          <div class="taocan_bd">
            <div class="product_tabs">
              <div id="spxqitem" class="sectionbox z-box">
                <div class="spxq_main">
                  <div>
                    <div>
                      <table>
