                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td width="72%" align="left" bgcolor="#FFFFFF">
                      <datepicker v-model="userInfo.birthday" language="ch" />
                    </td>
                  </tr>
                  <tr>
                    <td width="28%" align="right" bgcolor="#FFFFFF">性　别：</td>
                    <td width="72%" align="left" bgcolor="#FFFFFF">
                      <input id="male" v-model="userInfo.gender" type="radio" value="male">
                      <label for="male">男</label>
                      <input id="female" v-model="userInfo.gender" type="radio" value="female">
                  ...
                  <tr>
                    <td id="extend_field5i" width="28%" align="right" bgcolor="#FFFFFF">手机：</td>
                    <td width="72%" align="left" bgcolor="#FFFFFF">
                      <input v-model="userInfo.mobile" disabled name="extend_field5" type="text" class="inputBg"><span
                        style="color:#FF0000"
                      > *</span>
                    </td>
                  </tr>
