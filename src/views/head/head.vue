<template>
  <div id="header" class="new_header">
    <div>
      ...
      >
        <el-menu-item v-if="name" index="1" :style="{marginLeft: screenWidth > 1500 ? '60%' : '30%'}">
          <template>
            <router-link :to="'/app/home/member/userinfo'">{{ name }}</router-link>
            <a @click="loginOut">退出</a>
          </template>
        </el-menu-item>
        <el-menu-item v-else index="2" :style="{marginLeft: screenWidth > 1500 ? '60%' : '30%'}">
          <template>
            <router-link :to="{ name: 'login'}">登录</router-link>&nbsp;&nbsp;&nbsp;
            <router-link :to="{ name: 'register'}">注册</router-link>
          </template>
        </el-menu-item>
        <el-menu-item index="3" disabled style="margin-left: 10px">|</el-menu-item>
        <el-submenu index="4">
          ...
          <el-menu-item index="4-3">
            <template>
              <router-link :to="{ name: 'receive'}">修改收货地址</router-link>
            </template>
          </el-menu-item>
        </el-submenu>
        <el-menu-item index="5" disabled style="margin-right: 10px">|</el-menu-item>
        <el-menu-item index="6">
          <template>
            <router-link :to="{ name: 'userinfo'}">会员</router-link>
          </template>
        </el-menu-item>
        <el-menu-item index="7" disabled style="margin-left: 10px">|</el-menu-item>
        <el-menu-item index="8" style="margin-left: 10px">
          <template>
            <router-link :to="{ name: 'userinfo'}">甄选家</router-link>
          </template>
        </el-menu-item>
        <el-menu-item index="9" disabled style="margin-left: 10px">|</el-menu-item>
        <el-submenu index="10">
          <template #title>企业采购</template>
          <el-menu-item index="10-1">
            <template>
              <router-link :to="{ name: 'userinfo'}">企业购</router-link>
            </template>
          </el-menu-item>
          <el-menu-item index="10-2">
            <template>
              <router-link :to="{ name: 'userinfo'}">礼品卡</router-link>
            </template>
          </el-menu-item>
          <el-menu-item index="10-3">
            <template>
              <router-link :to="{ name: 'userinfo'}">联系我们</router-link>
            </template>
          </el-menu-item>
        </el-submenu>
        <el-menu-item index="11" disabled>|</el-menu-item>
        <el-submenu index="12" style="margin-right: 10px">
          <template #title>客户服务</template>
          <el-menu-item index="12-1">
            <template>
              <router-link :to="{ name: 'userinfo'}">在线客服</router-link>
            </template>
          </el-menu-item>
          <el-menu-item index="12-2">
            <template>
              <router-link :to="{ name: 'userinfo'}">帮助中心</router-link>
            </template>
          </el-menu-item>
          <el-menu-item index="12-3">
            <template>
              <router-link :to="{ name: 'userinfo'}">商务合作</router-link>
            </template>
          </el-menu-item>
          <el-menu-item index="12-4">
            <template>
              <router-link :to="{ name: 'userinfo'}">开放平台</router-link>
            </template>
          </el-menu-item>
        </el-submenu>
      </el-menu>
    ...
    <div class="hd_main cle">
      <div class="logo">
        <span style="color: #CB954C; font-family: 'Baskerville Old Face',fantasy; font-size: 35px">Shopping</span>
      </div>
      <div class="search_box">
        <el-input
          v-model="searchWord"
          placeholder="天天抽iphone 12"
          class="searchClass"
        >
          <template #prefix>
          ...
          <template #suffix>
            <el-button class="sea_btn" @click="searchSubmit">搜索</el-button>
          </template>
        </el-input>
      ...
      <div class="head_search_hot">
        <span style="font-size: 12px; font-family: 微软雅黑,cursive; color: #CC9756">热搜榜：</span>
        <span v-for="(item, index) in hotSearch" :key="index">
          <router-link
            :key="item.keywords"
            :to="'/search/'+item.keywords"
            style="font-size: 12px; font-family: 微软雅黑,cursive; color: #CC9756"
          >
            {{ item.keywords }}
          </router-link>
          <span v-if="index !== hotSearchLen -1" style="font-size: 10px">|</span>
        </span>
      </div>
      <div class="shop_cart">
        <el-popover
        ...
        >
          <template #reference>
            <router-link :to="{ name: 'cart' }" target="_blank">
              <span class="shop_cart_btn">
                <i id="shop_icon_btn" class="el-icon-shopping-cart-full">购物车</i>
                <el-badge
                  :value="goods_list.length"
                  type="danger"
          ...
          <div style="width: 306px; box-sizing: border-box; border-color: #CC9756">
            <ul style="overflow:auto; max-height: 300px">
              <li v-for="(item,index) in goods_list" :key="index" class="cartItem">
                <div class="item-left">
                  <router-link :to="'/productDetail/'+item.goods.id" target="_blank">
                    <el-image
                      style="width: 60px; height: 60px; opacity:0.4"
                ...
                <div class="item-middle">
                  <p class="nameDesc">
                    <router-link
                      :to="'/productDetail/'+item.goods.id"
                      target="_blank"
                      :title="item.goods.name"
                    >{{ item.goods.name | ellipsis }}
                    </router-link>
                  </p>
                  <p class="specValue">
                    <span>{{ '规格' }}</span>
                ...
                <div class="item-right">
                  ...
                  <p>
                    <el-button class="item-delete" @click="deleteGoods(index,item.goods.id)"><i
                      class="el-icon-close"
                    /></el-button>
                  </p>
                </div>
            ...
            <div class="cartBottom">
              <p style="margin: 5px 0 0 15px">商品合计:<span style="color: red"><em>{{ '￥' }}{{
                totalPrice
              }}</em></span>
                <router-link :to="'/shoppingcart/cart'" target="_blank" class="cartDeal">
                  去购物车结算
                </router-link>
              </p>
            </div>
    ...
    <div style="height: 60px;width:100%;text-align: center; display: inline">
      <el-menu class="el-menu-nav" mode="horizontal">
        ...
        <el-menu-item index="2">居家生活</el-menu-item>
        <el-menu-item index="3">服饰鞋包</el-menu-item>
        <el-menu-item index="4">美食酒水</el-menu-item>
        <el-menu-item index="5">个护清洁</el-menu-item>
        <el-menu-item index="6">母婴亲子</el-menu-item>
        <el-menu-item index="7">运动旅行</el-menu-item>
        <el-menu-item index="8">数码家电</el-menu-item>
        <el-menu-item index="9">严选全球</el-menu-item>
        <el-menu-item index="10">|</el-menu-item>
        <el-menu-item index="11">为你严选</el-menu-item>
        <el-menu-item index="12">众筹</el-menu-item>
      </el-menu>
...
export default {
  ...
  mounted() {
    ...
    window.onresize = function() { // 定义窗口大小变更通知事件
      ...
      if (that.screenWidth < 1055) {
        document.documentElement.clientWidth = 1055
      }
    }
  },
  ...
  // eslint-disable-next-line vue/order-in-components
  watch: {
    'screenWidth': function(new_val, old_val) { // 监听屏幕宽度变化
      if (new_val < 1500) {
  ...
  created() {
    ...
    // 更新store数据
    this.$store.dispatch('shop_cart/getInfo')// 获取购物车数据
  },
  methods: {
    loginOut() {
      // 跳转到登录
    ...
    searchSubmit() {
      if (this.searchWord) {
        console.log('name', this.name, 'totalPrice', this.totalPrice)
    ...
    deleteGoods(index, id) { // 移除购物车
      deleteShopCart(id).then((response) => {
        ...
        // 更新store数据
        this.$store.dispatch('shop_cart/getInfo')
    ...
    getHotSearch() { // 获取热搜
      getHotSearch()
        .then((response) => {
          ...
          this.hotSearchLen = this.hotSearch.length
        })
        .catch(function(error) {
          console.log(error)
        })
...
::v-deep .searchClass .el-input__inner {
  height: 38px;
  border-radius: 30px;
  border-color: #CC9756;
}
